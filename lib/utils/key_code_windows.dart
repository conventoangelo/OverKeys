...
/// Active Windows key code mapping that can be overridden by user configuration.
Map<(int, bool), String> activeKeyCodeShiftMap = Map<(int, bool), String>.from(
...
String getWindowsKeyFromKeyCodeShift(int keyCode, bool isShiftDown) {
